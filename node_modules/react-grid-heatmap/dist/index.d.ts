...
export declare const HeatMapGrid: ({ data, xLabels, yLabels, xLabelsPos, yLabelsPos, square, cellHeight, xLabelsStyle, yLabelsStyle, cellStyle, cellRender, onClick }: Props) => JSX.Element;
export {};
